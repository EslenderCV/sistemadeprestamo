...
public class mantenimientos extends javax.swing.JFrame {
    ...
    public mantenimientos(int accesslevel) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new mantenimientos(level).setVisible(true);
        });
    }
